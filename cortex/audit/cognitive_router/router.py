...
"""
COGNITIVE-ROUTER: Router Component.
"""
...
from cortex.audit.cognitive_router.models import RoutingDecision
from cortex.audit.ledger import EnterpriseAuditLedger

logger = logging.getLogger("cortex.audit.cognitive_router.router")
...
class CognitiveRouter:
    ...
    def __init__(
        ...
        # Extract categories defined in policy DSL
        categories_config = self.routing_policy.get(
            "categories", SafetyClassifier.DEFAULT_CATEGORIES
        )
