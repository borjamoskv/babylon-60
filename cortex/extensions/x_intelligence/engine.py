...
class XIntelligenceEngine:
    ...
    async def search_and_persist(self, query: str, limit: int = 20, project: str = "x-intelligence") -> XSearchResponse:
    ...
    async def get_user_and_persist(self, screen_name: str, project: str = "x-intelligence") -> XUser | None:
