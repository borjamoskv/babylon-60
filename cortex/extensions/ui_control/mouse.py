...
class MouseEngine:
    ...
    def click(self, x: int, y: int, button: str = "left") -> InteractionResult:
        ...
        time.sleep(HUMAN_CLICK_DELAY)  # noqa: TID251 - synchronous Quartz interaction
    ...
    def double_click(self, x: int, y: int) -> InteractionResult:
        ...
        time.sleep(0.05)  # noqa: TID251 - synchronous Quartz interaction
    ...
    def drag(
        ...
        for i in range(1, steps + 1):
            ...
            time.sleep(step_delay)  # noqa: TID251 - synchronous Quartz interaction
