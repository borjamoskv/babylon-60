    ...
    async def _do_remember(
        ...
        *,
        ...
        try:
            ...
            logger.exception("[P0] Untracked Exception: Projector on_remember failed for fact %d: %s", fact_id, e)
    ...
    async def _do_reflect(
        ...
        *,
        ...
        try:
            ...
            logger.exception("[P0] Untracked Exception: Projector on_reflect failed for project %s: %s", project, e)
            active_count = 0
            last_activity = None
        ...
        try:
            ...
            logger.exception("[P0] Untracked Exception: Projector on_reflect failed: %s", e)
            chain_valid = False
