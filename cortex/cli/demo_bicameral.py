...
def run_bicameral_demo():
    ...
    time.sleep(1)
    bicameral.log_limbic("ALERGIA DETECTADA: Intento de uso de TailwindCSS. El repo usa Vanilla CSS.", source="NEMESIS")
    time.sleep(1)
    bicameral.log_limbic("Estrategia alterada: Purgar intención de Tailwind. Forzar Vanilla CSS avanzado.", source="LORE")
    
    print()
    # 3. Reacción Autonómica (Tether verifica permisos)
    time.sleep(1)
    bicameral.log_autonomic("Verificando TETHER. Límite de tokens en sesión: 25,000 / 100,000.", check="BUDGET")
    time.sleep(0.5)
    bicameral.log_autonomic("Verificando acceso a sistema de archivos. Carpeta permitida: /src/components.", check="I/O")
