...
def run_swarm_demo():
    ...
    time.sleep(1)
    bicameral.log_motor("Petición: Refactor masivo de 50 archivos (Arquitectura Hexagonal).", action="SCOPE")
    time.sleep(1)
    bicameral.log_autonomic("Evaluación de recursos: Requiere Enjambre (>10 archivos).", check="CAPACITY")
    ...
    time.sleep(1)
    bicameral.log_limbic("Empaquetando 14 alergias operativas y 3 cicatrices críticas.", source="GENESIS")
    time.sleep(0.5)
    ...
    time.sleep(1)
    bicameral.log_limbic("Worker-02 reporta: Detectada inyección de dependencias errónea. Abortando por regla Nemesis-04.", source="SWARM")
    time.sleep(1)
    bicameral.log_limbic("Worker-03 reporta: Refactor completado esquivando error de concurrencia gracias a Cicatriz ep_0042.", source="SWARM")
