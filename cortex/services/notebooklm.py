...
DOMAIN_MAP: dict[str, list[str]] = {
    ...
    "cortex-products": [
        ...
        "SonicNotch", "moltbook", "MOLTBOOK", "Moltbook", "Moltbook Ledger",
        "Moltbook Monetization", "sonic-supreme", "sonic_sovereign",
        "mastering-1", "lyria-studio", "veo-lyria-studio", "filete-cumbia",
        "el-pueblo-online", "gordacorp", "borjamoskv", "borjamoskv.com",
        "borja.moskv.eth", "manteca-web", "comienzos-clone", "xokas-elevator",
        "garmin-dashboard", "millennium", "openclaw", "conspiracy-calculator",
        "RATIOHEAD", "noir-ui-kit", "impact-web", "FrontierApp",
    ],
    "cortex-operations": [
        "ghost-control", "ghost_control", "GHOST-1", "GHOST-CONTROL",
        "autorouter", "autorouter-1", "SAP", "sap", "SAP Audit",
        "SAP_SYNC", "sap-audit-ui", "mailtv-1", "MAILTV-1", "MAILING",
        "ecosistema", "global", "general", "reporting", "tips", "i18n",
        "IDC", "idc-agent", "JMIR", "JMIR-FREE-PUB-COMPLETED",
        "JMIR-FREE-TIERS", "EU_SCRAPER", "REDDIT_OVERLORD", "omni-translate",
    ],
    "cortex-strategy": [
        "COMMERCE-Ω", "Pricing", "ROI_LABOR", "moneytv", "moneytv-1",
        "cortex-landing", "landing", "landing-apotheosis",
        "CortexSovereignWeb", "cortex-sovereign-web", "moskvbot", "moskvbot-test",
    ],
    "cortex-research": [
        "EVOLUTION", "evolution", "Ouroboros", "ouroboros", "TEMPORAL",
        "TEMPORAL-RENAMING", "TEMPORAL-UNIFICATION", "SINGULARITY-OMEGA",
        "PORTAL-OMEGA", "VOID-SINGULARITY", "Synaptic/Causal", "APOTHEOSIS",
        "AUTODIDACT", "AUTO_MUTATE", "CHRONOS-1", "Sovereignty", "aether-omega",
        "keter", "keter-omega", "antigravity", "Antigravity", "Antigravity/CORTEX",
