...
from cortex.migrations.mig_ledger import (
    ...
    _migration_023_tenant_scoped_merkle_roots,
)
...
# The old migration 23 (mig_simplify_facts) was removed as incompatible with live schema.
# Reuse 23 only for the additive tenant-scoped Merkle root compatibility migration.
...
MIGRATIONS = [
    ...
    (23, "Tenant-scoped transaction Merkle roots", _migration_023_tenant_scoped_merkle_roots),
]
