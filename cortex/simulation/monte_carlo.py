...
class MonteCarloRecallEngine:
    ...
    def simulate(self, 
                 ...
                 momentum_factor: float = 0.8) -> List[MemoryTrajectory]:
        ...
        for i in range(n_samples):
            ...
            for step in range(max_steps):
                    ...
                    if neighbor_id in node_cache:
                        ...
                        if isinstance(neighbor_node.embedding, (list, np.ndarray)):
                            ...
                            if norm_n > 0 and norm_intent > 0:
                                ...
                                # Momentum alignment
                                alignment = np.dot(current_momentum, v_n) / (np.linalg.norm(current_momentum) * norm_n)
                ...
                if isinstance(next_node.embedding, (list, np.ndarray)):
                    ...
                    current_momentum = (current_momentum * momentum_factor) + (v_n * (1.0 - momentum_factor))
