...
_STOP_WORDS = frozenset(
    "a an the is are was were be been being have has had do does did will would could should may might shall can de del la el los las en un una y o que con por para se es no al su más como pero sin sobre to of in for on with at by from and or not but this that it its".split()
)
