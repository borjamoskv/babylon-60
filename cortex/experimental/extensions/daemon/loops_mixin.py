...
from cortex.experimental.extensions.daemon.models import DaemonStatus
...
class LoopsMixin:
    ...
    def _auto_sync(self, status: DaemonStatus) -> None:
        ...
        if not self._shared_engine:
            return
        try:
            from cortex.experimental.extensions.sync import export_snapshot, export_to_json, sync_memory
    ...
    def _run_health_loop(self) -> None:
        ...
        from cortex.experimental.extensions.daemon.health_loop import HealthLoop
