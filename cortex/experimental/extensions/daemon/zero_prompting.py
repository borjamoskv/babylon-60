...
logger = logging.getLogger("cortex.experimental.extensions.daemon.zero_prompting")
...
class ZeroPromptingDaemon:
    ...
    async def _act(self, _hypothesis: str, state: dict[str, Any]) -> dict[str, Any]:
        ...
        from cortex.experimental.extensions.evolution.ouroboros_omega import OuroborosOmega
        from cortex.experimental.extensions.mejoralo.engine import MejoraloEngine
