...
from cortex.experimental.extensions.daemon.models import CORTEX_DB, CORTEX_DIR, DEFAULT_CERT_WARN_DAYS
...
from cortex.experimental.extensions.daemon.sidecar.sentinel_monitor.monitor import SentinelMonitor
from cortex.experimental.extensions.daemon.sidecar.telemetry.fiat_oracle import FiatOracle

logger = logging.getLogger("moskv-daemon")

try:
    from cortex.experimental.extensions.aether.daemon import AetherDaemon, AetherMonitor
    from cortex.experimental.extensions.aether.queue import TaskQueue
...
try:
    from cortex.experimental.extensions.daemon.sidecar.telemetry.iot_oracle import IoTOracle
...
def init_external_oracles(
    ...
    try:
        ...
        from cortex.experimental.extensions.daemon.sidecar.telemetry import ASTOracle
