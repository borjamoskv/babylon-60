...
from cortex.experimental.extensions.daemon.models import NeuralIntentAlert
...
class NeuralIntentMonitor:
    ...
    def check(self) -> list[NeuralIntentAlert]:
        ...
        try:
            from cortex.experimental.extensions.agents.neural import NeuralIntentEngine
            from cortex.experimental.extensions.platform.sys import is_macos
