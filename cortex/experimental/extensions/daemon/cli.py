...
from cortex.experimental.extensions.daemon import (
    BUNDLE_ID,
    DEFAULT_COOLDOWN,
    DEFAULT_INTERVAL,
...
from cortex.experimental.extensions.platform.sys import get_service_dir, is_linux, is_macos, is_windows
...
def install() -> None:
    ...
    from cortex.experimental.extensions.daemon.platform import (
        install_linux,
        install_macos,
        install_windows,
    )
