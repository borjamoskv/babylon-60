...
from cortex.experimental.extensions.sync import SyncResult, WritebackResult
from cortex.experimental.extensions.sync.common import file_hash, load_sync_state

if TYPE_CHECKING:
    from cortex.engine import CortexEngine


logger = logging.getLogger("cortex.experimental.extensions.daemon.sync")
...
class CortexSyncManager:
    ...
    async def _merkle_pulse_sync(self) -> SyncResult:
        ...
        from cortex.experimental.extensions.sync.common import MEMORY_DIR
