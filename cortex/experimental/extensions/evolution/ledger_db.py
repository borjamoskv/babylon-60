...
from cortex.experimental.extensions.evolution.models import EvolutionMutation

logger = logging.getLogger("cortex.experimental.extensions.evolution.ledger_db")
