...
logger = logging.getLogger("cortex.experimental.extensions.thinking")

if TYPE_CHECKING:
    from cortex.experimental.extensions.thinking.fusion import FusedThought
...
class OrchestraIntrospectionMixin:
    ...
    async def omega_think(self, prompt: str) -> FusedThought:
        ...
        """
        from cortex.experimental.extensions.llm.sovereign import Inquisitor
