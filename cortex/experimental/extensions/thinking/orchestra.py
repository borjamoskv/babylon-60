...
from cortex.experimental.extensions.llm.router import CortexLLMRouter, CortexPrompt, IntentProfile
...
from cortex.experimental.extensions.thinking.orchestra_introspection import OrchestraIntrospectionMixin
from cortex.experimental.extensions.thinking.pool import ProviderPool, ThinkingRecord
from cortex.experimental.extensions.thinking.presets import (
    DEFAULT_ROUTING,
    MODE_SYSTEM_PROMPTS,
    OrchestraConfig,
    ThinkingMode,
)
from cortex.experimental.extensions.thinking.semantic_router import SemanticRouter
from cortex.utils.respiration import oxygenate

__all__ = ["ThoughtOrchestra"]

logger = logging.getLogger("cortex.experimental.extensions.thinking.orchestra")
...
class ThoughtOrchestra(OrchestraIntrospectionMixin):
    ...
    def _resolve_mode_aware_fallbacks(
        ...
        """
        from cortex.experimental.extensions.thinking.presets import DEFAULT_ROUTING, ThinkingMode
