...
from cortex.experimental.extensions.episodic.main import Episode, EpisodicMemory, Pattern
...
logger = logging.getLogger("cortex.experimental.extensions.episodic.boot")
