...
from cortex.experimental.extensions.shannon.analyzer import normalized_entropy
...
logger = logging.getLogger("cortex.experimental.extensions.shannon.immortality")
