...
from cortex.experimental.extensions.aether.models import AetherAlert, AgentTask, TaskStatus
...
logger = logging.getLogger("cortex.experimental.extensions.aether.daemon")
...
class AetherDaemon:
    ...
    def _github_poll_loop(self) -> None:
        ...
        from cortex.experimental.extensions.aether.github_ingestor import GitHubIngestor
