...
Usage::
    ...
    from cortex.experimental.extensions.signals.trigger_engine import TriggerEngine
    from cortex.experimental.extensions.signals.trigger_registry import register_defaults
...
logger = logging.getLogger("cortex.experimental.extensions.signals.trigger_registry")
...
def _register_p0_triggers(engine: TriggerEngine) -> None:
    ...
    engine.register(
        TriggerCondition(
            ...
            source_module="cortex.experimental.extensions.swarm.worktree_isolation",
        )
    )
    ...
    engine.register(
        TriggerCondition(
            ...
            source_module="cortex.experimental.extensions.swarm.swarm_heartbeat",
        )
    )
    ...
    engine.register(
        TriggerCondition(
            ...
            source_module="cortex.experimental.extensions.swarm.telemetry_gate",
        )
    )
...
def _register_p1_triggers(engine: TriggerEngine) -> None:
    ...
    engine.register(
        TriggerCondition(
            ...
            source_module="cortex.experimental.extensions.swarm.byzantine",
        )
    )
...
def _register_p2_triggers(engine: TriggerEngine) -> None:
    ...
    engine.register(
        TriggerCondition(
            ...
            source_module="cortex.experimental.extensions.signals.fact_hook",
        )
    )
    ...
    engine.register(
        TriggerCondition(
            ...
            source_module="cortex.experimental.extensions.swarm.error_ghost_pipeline",
        )
    )
