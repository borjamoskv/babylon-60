...
from cortex.experimental.extensions.swarm.knowledge_radar import discover
from cortex.experimental.extensions.swarm.nightshift_pipeline import NightShiftPipeline

logger = logging.getLogger("cortex.experimental.extensions.swarm.nightshift_daemon")
...
class NightShiftCrystalDaemon:
    ...
    async def _run_consolidation(self, cycle_id: str) -> dict[str, Any] | None:
        ...
        try:
            from cortex.experimental.extensions.swarm.crystal_consolidator import consolidate
            from cortex.experimental.extensions.swarm.crystal_thermometer import scan_all_crystals
