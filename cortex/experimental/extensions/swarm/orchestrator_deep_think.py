...
try:
    from cortex.experimental.extensions.agents.factory import create_agent  # type: ignore[import-not-found]
except ImportError:

    async def create_agent(*args: Any, **kwargs: Any) -> Any:  # type: ignore[misc]
        """Stub: agents.factory removed during extensions refactor."""
        raise NotImplementedError("cortex.experimental.extensions.agents.factory was removed")


from cortex.experimental.extensions.swarm.infinite_minds import InfiniteMindsManager
...
logger = logging.getLogger("cortex.experimental.extensions.swarm.deep_think")
        ...
        try:
            async with sem:
                ...
                if hasattr(agent, "router"):
                    from cortex.experimental.extensions.llm.router import CortexPrompt, IntentProfile
