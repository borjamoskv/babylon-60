...
from cortex.experimental.extensions.swarm.crystal_thermometer import CrystalVitals

logger = logging.getLogger("cortex.experimental.extensions.swarm.crystal_consolidator")
...
async def _execute_semantic_merge(
    ...
    """
    from cortex.experimental.extensions.swarm.crystal_synthesis import synthesize_crystals
