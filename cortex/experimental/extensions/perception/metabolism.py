...
# type: ignore
# try:
#     from cortex.experimental.extensions.perception.config import PERCEPTION_INTENSITY
# except ImportError:
PERCEPTION_INTENSITY = 0.5

logger = logging.getLogger("cortex.experimental.extensions.perception.metabolism")
