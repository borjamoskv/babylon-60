...
from cortex.experimental.extensions.zkortex.commitment import KnowledgeCommitment, commit
from cortex.experimental.extensions.zkortex.merkle import MerkleTree, ZKMembershipProof
from cortex.experimental.extensions.zkortex.range_proof import ZKRangeProof, prove_range

logger = logging.getLogger("cortex.experimental.extensions.zkortex.prover")
...
class ZKOrtexProver:
    ...
    def commit_to_fact(
        ...
        if metadata:
            ...
            from cortex.experimental.extensions.zkortex.commitment import KnowledgeCommitment as KC
