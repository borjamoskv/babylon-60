...
Wire-up::
    ...
    from cortex.experimental.extensions.notifications import get_notification_bus
...
logger = logging.getLogger("cortex.experimental.extensions.notifications.bus")
