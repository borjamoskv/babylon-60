...
from cortex.experimental.extensions.notifications.events import EventSeverity

if TYPE_CHECKING:
    from cortex.config import CortexConfig

logger = logging.getLogger("cortex.experimental.extensions.notifications.setup")
