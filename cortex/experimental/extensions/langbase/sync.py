...
if TYPE_CHECKING:
    ...
    from cortex.experimental.extensions.langbase.client import LangbaseClient

from cortex.experimental.extensions.langbase.client import LangbaseError  # noqa: E402

logger = logging.getLogger("cortex.experimental.extensions.langbase.sync")
