...
if TYPE_CHECKING:
    from cortex.experimental.extensions.mejoralo.engine import MejoraloEngine

from cortex.experimental.extensions.mejoralo.chronos import calculate_chronos_yield
...
from cortex.experimental.extensions.mejoralo.deps import sort_by_topological_order
from cortex.experimental.extensions.mejoralo.heal_prompts import (
    get_files_per_iteration as _get_files_per_iteration,
)
from cortex.experimental.extensions.mejoralo.models import ScanResult
from cortex.experimental.extensions.mejoralo.taint import is_file_tainted, mark_file_tainted
...
logger = logging.getLogger("cortex.experimental.extensions.mejoralo.heal")
...
def _calculate_total_complexity(source_code: str) -> int:
    ...
    from cortex.experimental.extensions.mejoralo.scan import _COMPLEXITY_NODES
...
def _run_healing_iteration(
    ...
    from cortex.experimental.extensions.mejoralo.scan import scan
