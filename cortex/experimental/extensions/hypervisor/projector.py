...
logger = logging.getLogger("cortex.experimental.extensions.hypervisor.projector")
...
class EventProjector:
    ...
    async def _verify_songlines(self, project: str) -> None:
        ...
        try:
            from cortex.experimental.extensions.sovereign.autopoiesis import Autopoiesis
