...
try:
    ...
    from cortex.experimental.extensions.health.models import Grade, HealthSLA, HealthSLAViolation  # type: ignore
except ImportError:
...
logger = logging.getLogger("cortex.experimental.guards.health")
