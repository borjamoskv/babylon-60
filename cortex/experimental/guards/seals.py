...
from cortex.experimental.guards._seal_printer import SealPrinter  # noqa: E402
from cortex.experimental.guards.sovereign_seals import (  # noqa: E402
...
async def check_seal_7_axiom_registry() -> GateResult:
    ...
    # ── Registry Sync ──
    try:
        from cortex.experimental.extensions.axioms import AXIOM_REGISTRY
        from cortex.experimental.extensions.axioms.registry import enforced
