...
from cortex.experimental.gateway.shield import APIShield

logger = logging.getLogger("cortex.experimental.gateway.spoof")
...
class SpoofManager:
    ...
    def _load_rules(self) -> dict[str, Any]:
        ...
        try:
            ...
            try:
                from cortex.experimental.extensions.immune.error_boundary import ErrorBoundary
