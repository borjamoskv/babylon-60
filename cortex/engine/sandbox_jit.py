...
class ASTSecurityScanner(ast.NodeVisitor):
    ...
    """
    FORBIDDEN_NAMES = {"eval", "exec", "__import__", "open", "getattr", "setattr", "delattr", "compile"}
...
class SandboxJIT:
    ...
    """
    def __init__(self, allowed_globals: Optional[Dict[str, Any]] = None):
        self.allowed_globals = allowed_globals or {"__builtins__": {
            "print": print,
            "len": len,
            "range": range,
            "str": str,
    ...
    def execute(self, code_str: str, context: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        """
