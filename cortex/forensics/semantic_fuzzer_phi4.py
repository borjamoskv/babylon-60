...
def main():
    ...
    if mutations > 0:
        ...
        if code == 0:
            console.print("[bold red]CRITICAL: El mutante sobrevivió e informó éxito. Unknown Unknown de lógica materializado.[/bold red]")
        else:
            console.print("[bold green]El mutante colapsó (Exit != 0). El sistema detectó la corrupción de la lógica de auditoría.[/bold green]")
    else:
        console.print("[dim]No se generaron mutaciones. Entropía insuficiente en esta iteración.[/dim]")
