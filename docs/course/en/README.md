...
1. [AI Agent Swarms](agent-swarms.md)
2. [LLM and AI Agent Optimization](llm-agent-optimization.md)
3. [Persistent Memory for AI Agents](persistent-memory.md)
...
1. Pick a track.
2. Read the repo anchors before the labs.
3. End with your own design note, audit, or consolidation proposal.
