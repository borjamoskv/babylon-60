...
# 🛡️ [DEPRECATED] HaikuGuard (Ω₄) — Aesthetic Integrity

> [!WARNING]
> **DEPRECATED**: HaikuGuard is deprecated and replaced by **LandauerGuard** (`docs/security/LANDAUERGUARD.md`). Phonetic heuristics introduced non-determinism, violating the C5-REAL requirement for absolute, deterministic guards in the Write-Path Contract.

**Component:** `cortex/security/haiku.py`
**Status:** `DEPRECATED`
