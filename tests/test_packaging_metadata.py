...
def test_heavy_dependencies_live_in_optional_extras() -> None:
    ...
    assert extras["all"] == [
        "cortex-persist[llm,streaming,compute,secure,api,mcp,daemon,platform,authoring,dev,adk,toolbox,billing,cloud,trends,embeddings,acceleration,bci,graph,quality]"
    ]
