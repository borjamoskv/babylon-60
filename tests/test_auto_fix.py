...
@pytest.mark.asyncio
@patch("legacy_research.extensions.swarm.auto_fix.AutoFixPipeline._execute")
@patch("legacy_research.extensions.swarm.auto_fix.AutoFixPipeline._escalate")
...
async def test_process_ghost_unknown_classification():
    ...
    with patch("legacy_research.extensions.swarm.auto_fix.AutoFixPipeline._execute") as mock_exe:
        result = await pipeline.process_ghost(ghost)
