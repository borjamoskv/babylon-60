...
def valid_bundle(tmp_path, km):
    ...
    export_data = [
        {"audit_id": audit_id_1, "prev_hash": prev_hash, "signature": signature, "external_anchor": None},
        {"audit_id": audit_id_2, "prev_hash": prev_hash, "signature": signature, "external_anchor": None}
    ]
