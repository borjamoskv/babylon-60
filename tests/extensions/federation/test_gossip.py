...
async def test_gossip_node_communication_and_discovery() -> None:
    ...
    node_a = GossipNode(node_id="node_a", bind_port=17335)
    node_b = GossipNode(node_id="node_b", bind_port=17336)
    ...
    try:
        ...
        await node_a.register_peer("node_b", "127.0.0.1:17336")
        ...
        assert node_b.peers["node_a"]["address"] == "127.0.0.1:17335"
        ...
        await node_c.start()
        try:
            await node_c.register_peer("node_a", "127.0.0.1:17335")
            ...
            assert node_c.peers["node_b"]["address"] == "127.0.0.1:17336"
