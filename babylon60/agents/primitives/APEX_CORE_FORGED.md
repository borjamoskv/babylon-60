...
| **AP-10** | **Ontological Bloat** | `Axioma_size > 256 bytes` | `Compresión Forzosa` | Aplicar Ley de Landauer |
...
| **AP-13** | **Type Shadowing** | `Variable override explícito de tipo en RAM` | `Pyright Fail` | Strict Static Typing |
...
| **AP-20** | **Conversational Muting** | `Ocultar P0 en respuesta LLM por empatía` | `Degradación de Trust` | Exposición Criptográfica Cruda |
| **AP-21** | **Unsafe I/O Ingestion** | `Consumir JSON/YAML sin validación de esquema` | `Fallo en persistence` | Validadores Pydantic/Zod/Structs estrictos |
