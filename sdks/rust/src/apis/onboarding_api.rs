...
/// struct for typed errors of method [`signup_v1_signup_post`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum SignupV1SignupPostError {
...
pub async fn signup_v1_signup_post(configuration: &configuration::Configuration, signup_request: models::SignupRequest) -> Result<models::SignupResponse, Error<SignupV1SignupPostError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<SignupV1SignupPostError> = serde_json::from_str(&content).ok();
