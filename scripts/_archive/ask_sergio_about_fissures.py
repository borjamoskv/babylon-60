...
async def main():
    ...
    print(
        "Consultando a Sergio (Frontend Models via Sovereign Router) sobre fisuras de seguridad..."
    )

    response = await router.query(prompt=prompt, intent="security_audit", require_frontier=True)
