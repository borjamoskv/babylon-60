...
for Babylon60-Persist. An ATMS maintains a record of which assumptions underlie each belief,
...
- **Node** $n$: A `BeliefObject` in the BABYLON60 ontology.
...
*BABYLON60-Persist · ATMS Semantics Appendix v0.1 · EXPERIMENTAL · 2026-03-14*
