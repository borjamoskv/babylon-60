...
def main():
    ...
    for q in queries:
        ...
        try:
            ...
            print(f"Intent -> Temporal Bias: {intent.temporal_bias}, Abstraction: {intent.abstraction_level}")
            ...
            for i, node in enumerate(subgraph.nodes):
                print(f"  [{i+1}] Node ID: {node.id} | Type: {node.fact_type} | Content: {node.content[:60]}...")
